        ...
        static void Main(string[] args)
        {
            ...
            while (runProgram)
            {
                ...
                switch (selection)
                {
                    ...
                    case ("Delete a chore"):
                        List<Chore> allChoresToBeDeleted = choreRepo.GetAll();
                        foreach (Chore c in allChoresToBeDeleted)
                        {
                            Console.WriteLine($"{c.Id}. {c.Name} ");
                        }
                        Console.Write("Which chore would you like to Delete? ");
                        int selectedChoreIdToDelete = int.Parse(Console.ReadLine());
                        Chore selectedChoreToDelete = allChoresToBeDeleted.FirstOrDefault(c => c.Id == selectedChoreIdToDelete);
